...
const CarDetail = () => {
  ...
  useEffect(() => {
    ...
    CarServices.getCarById(params.id)
      .then((response) => {
            ...
            <div className="card-body">
              <div>
                <h5 className="card-title">
                  ...
                  {carObj.carModel} | {carObj.mileage} {" kmpl"}
                </h5>
                <p className="card-text">
                  {" "}
                  <FontAwesomeIcon icon={faChair} />
                  {carObj.carType} | {carObj.seating} Seater
                </p>
                <p className="card-text">
                  {" "}
                ...
                <p className="card-text">
                  ...
                  {carObj.sourceLocation} - {carObj.destinationLocation}
                </p>

                <p className="card-text">
                  <FontAwesomeIcon icon={faCalendarAlt} />
                  FROMDATE: {carObj.fromDate}
                </p>
                <p className="card-text">
                  {" "}
                  <FontAwesomeIcon icon={faCalendarAlt} />
                  TODATE: {carObj.toDate}
                </p>
                <h2 className="card-text">
                  {" "}
                  <FontAwesomeIcon icon={faDollarSign} />
                  PRICE:{carObj.price}/hr
                </h2>
              </div>
              <br />
              <div>
